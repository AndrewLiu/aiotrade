 ...
 * @author Caoyuan Deng
 */
public class AIOTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected int getTabRunOverlay(int tabPlacement) {
        ...
        if (tabPlacement == LEFT || tabPlacement == RIGHT) {
            int maxTabHeight1 = calculateMaxTabHeight(tabPlacement);
            return maxTabHeight1 / 2;
        }
        return 0;
    }
