...
public class OrderDlg extends JDialog {
    ...
    private JTextField	m_BackfillDuration = new JTextField( "300 S");
    private JTextField  m_BarSizeSetting = new JTextField("1");
    private JTextField	m_UseRTH = new JTextField( "1");
    private JTextField	m_FormatDate = new JTextField( "1");
    private JTextField	m_WhatToShow = new JTextField( "MIDPOINT");
    ...
    private JTextField 	m_primaryExch = new JTextField( "SUPERSOES" );
    ...
    void onOk() {
        ...
        try {
            ...
            m_barSizeSetting = Integer.parseInt( m_BarSizeSetting.getText());
