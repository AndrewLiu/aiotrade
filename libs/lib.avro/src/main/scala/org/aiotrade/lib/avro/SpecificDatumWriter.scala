...
object SpecificDatumWriter {
  def apply[T](root: Schema, data: SpecificData) = new SpecificDatumWriter[T](root, data)
  def apply[T](root: Schema) = new SpecificDatumWriter[T](root, SpecificData.get)
  def apply[T](data: SpecificData) = new SpecificDatumWriter[T](null, data)
  def apply[T]() = new SpecificDatumWriter[T](null, SpecificData.get)
}
