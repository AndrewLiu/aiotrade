...
public class ApacheAvroMarshallerTest {
   ...
   public void testListMapMarshalling() {
       
      List<Map<Long, Float>> numberses = new ArrayList<Map<Long, Float>>(); 
      ...
      Map<Long, Float> numbers1 = new HashMap<Long, Float>();
      numbers1.put(9223372036854775807L, 4732.4f);
      numbers1.put(72057594037927936L, 67484.32f);
      numbers1.put(7205759412424936L, 132367484.32f);
     numberses.add(numbers1);
      assertEquality(numberses);
   ...
   private Object marshallUnmarshall(Object o) {
      try {
         ...
         Object or = marshaller.objectFromByteBuffer(buffer);
