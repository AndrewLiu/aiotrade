...
class ValidationException(val errors: ValidationError*) extends CircumflexException("Validation failed.") {
...
object Validator {
  ...
  class RecordFieldValidator[R](val column: Column[_, R], validator: Validator) extends RecordValidator[R] {
