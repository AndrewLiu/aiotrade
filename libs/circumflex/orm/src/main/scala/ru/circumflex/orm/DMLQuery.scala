...
object DMLQuery {
   ...
   * columns.
   */
  class InsertSelect[R](val relation: Relation[R], val query: Select) extends DMLQuery {
   ...
   */
  class Delete[R](val relation: RelationNode[R]) extends DMLQuery {
   ...
   */
  class Update[R](val relation: Relation[R]) extends DMLQuery {
