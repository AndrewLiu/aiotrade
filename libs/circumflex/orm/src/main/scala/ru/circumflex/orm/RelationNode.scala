 ...
 */
abstract class RelationNode[R: Manifest](val relation: Relation[R]) extends Relation[R]
                                                             with SQLable
                                                             with Cloneable {
...
object RelationNode {
  ...
  class TableNode[R: Manifest](val table: Table[R]) extends RelationNode[R](table) {
  ...
  class ViewNode[R: Manifest](val view: View[R]) extends RelationNode[R](view) {
   ...
   */
  abstract class JoinNode[L: Manifest, R](protected var _left: RelationNode[L],
   ...
   */
  class ExplicitJoin[L: Manifest, R](_left: RelationNode[L],
   ...
   */
  class ChildToParentJoin[L: Manifest, R](childNode: RelationNode[L],
   ...
   * with association-based condition.
   */
  class ParentToChildJoin[L: Manifest, R](parentNode: RelationNode[L],
