 ...
 */
abstract class LocalizableView[R: Manifest] extends View[R] with LongIdPK[R] {
...
class LocaleDataTable[R: Manifest](val localizableView: LocalizableView[R]) extends Table[R] with LongIdPK[R] {
...
class RawDataTable[R: Manifest](val localizableView: LocalizableView[R]) extends Table[R] {
...
class LocalizableViewInsertRule[R](val localizableView: LocalizableView[R]) extends SchemaObject {
...
class LocalizableViewUpdateRule[R](val localizableView: LocalizableView[R]) extends SchemaObject {
...
class LocalizableViewDeleteRule[R](val localizableView: LocalizableView[R]) extends SchemaObject {
